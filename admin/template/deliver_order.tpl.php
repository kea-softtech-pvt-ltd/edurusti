			...
			<div class="col-sm-12">
...

				{
...

					{
						...
						if($Repair_mob[$i]['track_status'] == '5')
						{	
						?>
						...
						<tr>
						   ...
						   <td>
							...
							<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#ordine" onclick="generateOTP('<?php echo $Repair_mob[$i]['cust_id']; ?>','<?php echo $Repair_mob[$i]['order_number']; ?>','6');">Generate OTP</button>
